...
param_latex_dict = {
    ...
    "g_star": r"g_\star",
    "f_star": r"f_\star",
    "ln_tau_0": r"\mathrm{ln} \tau_0",
    "ln_tau_1": r"\mathrm{ln} \tau_1",
    "ln_tau_2": r"\mathrm{ln} \tau_2",
    "ln_tau_3": r"\mathrm{ln} \tau_3",
    "ln_tau_4": r"\mathrm{ln} \tau_4",
    "ln_sigT_kms_0": r"\mathrm{ln} \sigma^T_0",
    "ln_sigT_kms_1": r"\mathrm{ln} \sigma^T_1",
    "ln_sigT_kms_2": r"\mathrm{ln} \sigma^T_2",
    "ln_sigT_kms_3": r"\mathrm{ln} \sigma^T_3",
    "ln_sigT_kms_4": r"\mathrm{ln} \sigma^T_4",
    "ln_gamma_0": r"\mathrm{ln} \gamma_0",
    "ln_gamma_1": r"\mathrm{ln} \gamma_1",
    "ln_gamma_2": r"\mathrm{ln} \gamma_2",
    "ln_gamma_3": r"\mathrm{ln} \gamma_3",
    "ln_gamma_4": r"\mathrm{ln} \gamma_4",
    "ln_kF_0": r"\mathrm{ln} k^F_0",
    "ln_kF_1": r"\mathrm{ln} k^F_1",
    "ln_kF_2": r"\mathrm{ln} k^F_2",
    "ln_kF_3": r"\mathrm{ln} k^F_3",
    "ln_kF_4": r"\mathrm{ln} k^F_4",
    "H0": "H_0",
    "mnu": "\\Sigma m_{\\nu}",
    "As": "A_s",
    "ns": "n_s",
